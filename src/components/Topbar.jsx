...
export default function Topbar({ className }) {
  return (
    <header className={`h-16 bg-white border-b border-slate-200 flex items-center justify-between px-4 lg:px-8 z-40 ${className || ''}`} data-purpose="top-bar">
      ...
      <div className="flex items-center space-x-3 sm:space-x-4 lg:space-x-6 shrink-0">
        <button className="md:hidden text-slate-500 hover:text-shipdesk-blue"><svg className="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path></svg></button>
        ...
        <div className="flex items-center space-x-3 lg:border-l lg:pl-6 border-slate-200">
          ...
          <img alt="Profile" className="h-8 w-8 lg:h-10 lg:w-10 rounded-full border-2 border-white shadow-sm" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCvgsBFE7khb7K_wXVYo504YDcqOWrOlDCtz3a_qar_FvM5yW3A1T5s877fyYm5wxWK7kDiiGNZuglogztAnhEIizhBNEMWG5jFJ1jndoHYmKN0JFlbv2aUW9QGU1UDEKClGrxD5qLLnsxAjrf6t4VfupL7l6UvRAQsVhwFCKo918l1knniOCtw2BbX4Tz8s0pBd8w7BNBhDQVJl4PQvjH69D5gRLrNgmZ7q5__tGFiADO6UxCg5etoPrB8wUlqJ1KA_pMMP7JvoQxe" />
        </div>
      </div>
    </header>
  );
